@php
  ...
  $value = isset($field->hidden_field_value) ? $field->hidden_field_value : $field->data;
  if (isset($form->defaultFields, $form->defaultFields[$field->field_name])) {
      $value = $form->defaultFields[$field->field_name];
  }
  if (isset($form->defaultFields, $field->custom_class, $form->defaultFields[$field->custom_class])) {
